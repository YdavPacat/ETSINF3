...
namespace TarongISWPesistenceTest
{
    public class TestData
    {
        ...
        public static Person EXPECTED_PARCEL_OWNER = new Person(EXPECTED_PERSON_ID, EXPECTED_PERSON_NAME);
        ...
        public static Parcel EXPECTED_PARCEL = new Parcel(EXPECTED_PARCEL_CADASTRALREFERENCE, EXPECTED_PARCEL_NAME, EXPECTED_PARCEL_PRODUCT, EXPECTED_PARCEL_SIZE, EXPECTED_PARCEL_OWNER);
