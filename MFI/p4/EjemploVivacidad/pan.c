...
/*** From source: ejemploVivacidad.pml ***/
...
short src_ln0 [] = {
	  0,   6,   8,   8,   9,   9,  11,  12, 
	 13,  10,  15,  17,  18,  16,  20,  20, 
	  7,  22,   7,  22,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "ejemploVivacidad.pml", 1, 19 },
	{ "-", 20, 21 }
};
uchar reached0 [] = {
	  0,   0,   1,   0,   1,   0,   1,   0, 
...
printm(int x, char *s)
{
	...
	switch (x) {
	case 1: Printf("exiting"); return;
	case 2: Printf("critical"); return;
	case 3: Printf("entering"); return;
